<template>
  <header>
    ...
    <nav>
      <ul>
        ...
        <li>
          ...
          <base-badge mode="elegant">{{ totalQuantity }}</base-badge>
        </li>
    ...
    <div>
      <button v-if="!isAuthentication" @click="login">Login</button>
      <button v-if="isAuthentication" @click="logout">Logout</button>
    </div>
  </header>
</template>
